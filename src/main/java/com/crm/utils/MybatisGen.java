...
public class MybatisGen {
    ...
    public static void main(String[] args) {
        String path = System.getProperty("user.dir").concat(File.separator).concat("src").concat(File.separator).concat("main")
                .concat(File.separator).concat("java").concat(File.separator).concat("crm").concat(File.separator).concat("vact").concat(File.separator);
        ...
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/db_crm", "root", "94420991207")
